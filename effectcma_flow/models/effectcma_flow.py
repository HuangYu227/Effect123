...
class EffectCMAFlow(nn.Module):
    ...
    def forward(
        ...
        mapper_kwargs = {}
        if getattr(self.mapper, "operator_router", "text") == "dual":
            mapper_kwargs = {"series_stats": _series_router_stats(x_t), "flow_time": t}
        g_patch, aux = self.mapper(slot_tokens, time_tokens, channel_tokens, slot_mask, **mapper_kwargs)
